...
index<-c(4,26,27,28)
a<- subset(data_10801,area == "東區" & gender == "計")[, index]
b<- subset(data_10802,area == "東區" & gender == "計")[, index]
c<- subset(data_10803,area == "東區" & gender == "計")[, index]
d<- subset(data_10804,area == "東區" & gender == "計")[, index]
e<- subset(data_10805,area == "東區" & gender == "計")[, index]
f<- subset(data_10806,area == "東區" & gender == "計")[, index]
g<- subset(data_10807,area == "東區" & gender == "計")[, index]
h<- subset(data_10808,area == "東區" & gender == "計")[, index]
i<- subset(data_10809,area == "東區" & gender == "計")[, index]
j<- subset(data_10810,area == "東區" & gender == "計")[, index]
k<- subset(data_10811,area == "東區" & gender == "計")[, index]
l<- subset(data_10812,area == "東區" & gender == "計")[, index]
aa<- subset(data_10901,area == "東區" & gender == "計")[, index]
bb<- subset(data_10902,area == "東區" & gender == "計")[, index]
cc<- subset(data_10903,area == "東區" & gender == "計")[, index]
dd<- subset(data_10904,area == "東區" & gender == "計")[, index]
ee<- subset(data_10905,area == "東區" & gender == "計")[, index]
ff<- subset(data_10906,area == "東區" & gender == "計")[, index]
gg<- subset(data_10907,area == "東區" & gender == "計")[, index]
hh<- subset(data_10908,area == "東區" & gender == "計")[, index]
ii<- subset(data_10909,area == "東區" & gender == "計")[, index]
jj<- subset(data_10910,area == "東區" & gender == "計")[, index]
kk<- subset(data_10911,area == "東區" & gender == "計")[, index]
ll<- subset(data_10912,area == "東區" & gender == "計")[, index]
aaa<- subset(data_11001,area == "東區" & gender == "計")[, index]
bbb<- subset(data_11002,area == "東區" & gender == "計")[, index]
ccc<- subset(data_11003,area == "東區" & gender == "計")[, index]
ddd<- subset(data_11004,area == "東區" & gender == "計")[, index]
eee<- subset(data_11005,area == "東區" & gender == "計")[, index]
fff<- subset(data_11006,area == "東區" & gender == "計")[, index]
ggg<- subset(data_11007,area == "東區" & gender == "計")[, index]
hhh<- subset(data_11008,area == "東區" & gender == "計")[, index]
iii<- subset(data_11009,area == "東區" & gender == "計")[, index]
jjj<- subset(data_11010,area == "東區" & gender == "計")[, index]
...
write.csv(new_data2, "東區.csv", row.names = FALSE)